...
<xsl:variable name="LAYOUT">
    ...
    <div class="sf-container">
        ...
        <layout:form action="/customactions/requestSave.action" xmlTag="request">
            ...
            <layout:simple-field label="Показатель" class="full" required="0">
                <layout:multiselect value="//TEST_VALUE" limit="1" listSourceID="nsi_request_all" name="search" xmlTag=":name:" />
            </layout:simple-field>

            <layout:simple-field label="Статус" class="full checkBox" required="0">
                <layout:checkbox forceCheckbox="1" label="Достигнут" name="done" xmlTag=":name:" />
                <layout:checkbox forceCheckbox="1" label="Не достигнут" name="done" xmlTag=":name:" />
