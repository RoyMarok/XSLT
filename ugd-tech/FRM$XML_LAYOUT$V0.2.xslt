    ...
    <!-- **** элементы разметки **** -->
    {B{FRM$XML_LAYOUT$V0.2-SECTION}E}
    {B{FRM$XML_LAYOUT$V0.2-FORM}E}
    {B{FRM$XML_LAYOUT$V0.2-COMMON}E}
    {B{FRM$XML_LAYOUT$V0.2-CHECKBOX}E}
    {B{FRM$XML_LAYOUT$V0.2-TABLE}E}
    {B{FRM$XML_LAYOUT$V0.2-SELECT}E}
    {B{FRM$XML_LAYOUT$V0.2-RADIO}E}
    ...
    <xsl:template name="pageBuilder">
        ...
        <xsl:param name="customStyles" required="yes"/>
              ...
              margin-left: 20px;
                        ...
                        {B{FRM$XML_LAYOUT$V0.2-BASIC_STYLES}E}
        ...
        <xsl:call-template name="Context.execute">
            ...
            <xsl:with-param name="markup" select="$layout">
                        ...
                        <script type="text/javascript" src="/ugd/js/spbren/configuration.js"></script>
