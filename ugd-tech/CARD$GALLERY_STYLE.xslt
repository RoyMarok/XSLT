  ...
  /*   -------- Стили для галереи ------------*/
    ...
    .gallery-right {  width: 300px; margin-bottom:20px; }
      ...
      .gallery-right .other-images {  width: 100%;   height: 200px;   overflow-x: auto; margin-bottom:35px}
        ...
        .pdoc-left-side .gallery-right .other-images .wrp-images { height: 78px;}
          ...
          .pdoc-left-side .gallery-right .other-images .wrp-images a.link-image img {width: 55px; height: 75px;}
