        ...
        <layout:form action="/customactions/requestSave.action" xmlTag="request">
          ...
          <div class="steps" id="step1">
            ...
            <layout:simple-field label="" class="full radioGroup_list radio ur_fiz" required="0">
                        ...
                        <layout:simple-field label="Номер положительного заключения гос. Экологической экспертизы" class="full double_line" required="0">
                            <layout:edit type="TEXT" value="//REGUEST//ECO_EXPERT_NUMBER" name="req_request__eco_expert_number" xmlTag=":name:"/>
                        </layout:simple-field>
                        <layout:simple-field label="Дата положительного заключения гос. Экологической экспертизы" class="full double_line" required="0">
                          ...
                          <layout:section select="//OBJ_PARAMETER//ROW" xmlTag="obj_parameter" class="topSection" add="1" delete="1">
                            ...
                            <div class="tep_right">
                                <div class="tep_params">
                                    ...
                                    <layout:multiselect value="NSI_OBJECT_PARAMETER" limit="100" listSourceID="nsi_object_param" name="obj_parameter__nsi_object_params" viewingId="57949E9FAB23443F98CA918599BCFABA" multiple="true" xmlTag=":name:" style="width:609px;"/>
          ...
          <div class="steps" id="step3">
            ...
            <layout:simple-field label="" class="small checkBox" required="0">
                            <div class="one_must_be">
                                <layout:checkbox forceCheckbox="1" label="Получить лично" name="req_request__is_result_offline" valueXPATH="//IS_RESULT_OFFLINE" valueChecked="1" xmlTag=":name:"/>
                                <layout:checkbox forceCheckbox="1" label="Получить через ЛК" name="req_request__is_result_online" valueXPATH="//IS_RESULT_ONLINE" valueChecked="1" xmlTag=":name:"/>
                            </div>
                        </layout:simple-field>
            ...
            <layout:simple-field label="Информирование об изменениях" class="full double_line checkBox" required="1">
                    ...
                    <div class="steps" id="step4">
                        ...
                        <div class="double_line centered">
                            ...
                            <p>Перед отправкой заявления прверьте правильность заполнения формы и наличие загруженных файлов проектной документации.</p>
                        </div>
    ...
    function dateMask(){
      ...
      function all_masks(){
        ...
        $(function(){
            ...
            $('.fileExistAction:not(.disable)').click(function(){
                    ...
                    .success(function(data){
                        ...
                        if (data.data<1){
                            ...
                            $('#nofiles .agree').click(function(){
                                $('[name="req_request__nsi_request_status"]').val('NEW_REQUEST');
