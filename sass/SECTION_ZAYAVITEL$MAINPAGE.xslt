...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
    ...
    <xsl:template match="/">
      ...
      <a class="lk-header-link lk-header-link-instruction" href="/portal/tabInfo.action?tab=SECTION_ZAYAVITEL#tab::id=0/card::cardId=CARD_ZAYAVITEL_INSTRUCTION">
        <i></i>
        <span>Инструкция</span>
      </a>
      <a class="lk-header-link lk-header-link-info" href="/portal/tabInfo.action?tab=SECTION_ZAYAVITEL#tab::id=0/card::cardId=CARD_ZAYAVITEL_TECH_HELP">
        <i></i>
        ...
        <script>
            $(function(){
                $('#headerButtons').insertAfter('#headerContentArea');
            })
        </script>
    </xsl:template>
</xsl:stylesheet>
